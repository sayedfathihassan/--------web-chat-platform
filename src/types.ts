...
export const DEFAULT_SHOP_ITEMS = [
  ...
  { id: 'b0b0b0b0-1111-4000-8000-000000000001', name_ar: 'الشاب الأنيق', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Felix', preview_css: 'avatar-boy', points_cost: 100, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000002', name_ar: 'المغامر الشجاع', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Max', preview_css: 'avatar-boy', points_cost: 200, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000003', name_ar: 'النينجا الغامض', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jack', preview_css: 'avatar-boy', points_cost: 500, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000004', name_ar: 'ملك القراصنة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Leo', preview_css: 'avatar-boy', points_cost: 1000, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000005', name_ar: 'اللاعب المحترف', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Milo', preview_css: 'avatar-boy', points_cost: 300, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000006', name_ar: 'رجل الأعمال', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jasper', preview_css: 'avatar-boy', points_cost: 1500, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000007', name_ar: 'الموسيقار المبدع', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Oliver', preview_css: 'avatar-boy', points_cost: 400, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000008', name_ar: 'فارس الظلام', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Shadow', preview_css: 'avatar-boy', points_cost: 2000, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000009', name_ar: 'القائد العسكري', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=General', preview_css: 'avatar-boy', points_cost: 1200, is_active: true },
  { id: 'b0b0b0b0-1111-4000-8000-000000000010', name_ar: 'الأسطورة الذهبية', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Gold', preview_css: 'avatar-boy', points_cost: 5000, is_active: true },
  
  // 12. Custom Avatars - Girls (10 Items)
  { id: 'g0g0g0g0-2222-4000-8000-000000000001', name_ar: 'الفتاة الحالمة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luna', preview_css: 'avatar-girl', points_cost: 100, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000002', name_ar: 'الملكة المتوجة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Queen', preview_css: 'avatar-girl', points_cost: 1500, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000003', name_ar: 'زهرة اللوتس', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Lily', preview_css: 'avatar-girl', points_cost: 300, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000004', name_ar: 'سيدة الأناقة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Grace', preview_css: 'avatar-girl', points_cost: 800, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000005', name_ar: 'المبدعة الصغيرة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Mia', preview_css: 'avatar-girl', points_cost: 200, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000006', name_ar: 'فراشة الربيع', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Bella', preview_css: 'avatar-girl', points_cost: 400, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000007', name_ar: 'أميرة القصر', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Princess', preview_css: 'avatar-girl', points_cost: 2500, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000008', name_ar: 'الفارسة الشجاعة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Aria', preview_css: 'avatar-girl', points_cost: 600, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000009', name_ar: 'نجمة السينما', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Star', preview_css: 'avatar-girl', points_cost: 3000, is_active: true },
  { id: 'g0g0g0g0-2222-4000-8000-000000000010', name_ar: 'الجوهرة المصونة', category: 'avatar', image_url: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jewel', preview_css: 'avatar-girl', points_cost: 4500, is_active: true },
];
