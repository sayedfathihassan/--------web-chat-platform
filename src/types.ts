...
export const DEFAULT_SHOP_ITEMS = [
  ...
  { id: 'a0a0a0a0-1111-4000-8000-000000000003', name_ar: 'النينجا الغامض', category: 'avatar', image_url: '/avatars/boy-3.png', preview_css: 'avatar-boy', points_cost: 500, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000004', name_ar: 'ملك القراصنة', category: 'avatar', image_url: '/avatars/boy-4.png', preview_css: 'avatar-boy', points_cost: 1000, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000005', name_ar: 'اللاعب المحترف', category: 'avatar', image_url: '/avatars/boy-5.png', preview_css: 'avatar-boy', points_cost: 300, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000006', name_ar: 'رجل الأعمال', category: 'avatar', image_url: '/avatars/boy-6.png', preview_css: 'avatar-boy', points_cost: 1500, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000007', name_ar: 'الموسيقار المبدع', category: 'avatar', image_url: '/avatars/boy-7.png', preview_css: 'avatar-boy', points_cost: 400, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000008', name_ar: 'فارس الظلام', category: 'avatar', image_url: '/avatars/boy-8.png', preview_css: 'avatar-boy', points_cost: 2000, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000009', name_ar: 'القائد العسكري', category: 'avatar', image_url: '/avatars/boy-9.png', preview_css: 'avatar-boy', points_cost: 1200, is_active: true },
  { id: 'a0a0a0a0-1111-4000-8000-000000000010', name_ar: 'الأسطورة الذهبية', category: 'avatar', image_url: '/avatars/boy-10.png', preview_css: 'avatar-boy', points_cost: 5000, is_active: true },
  ...
  { id: 'e0e0e0e0-2222-4000-8000-000000000003', name_ar: 'زهرة اللوتس', category: 'avatar', image_url: '/avatars/girl-3.png', preview_css: 'avatar-girl', points_cost: 300, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000004', name_ar: 'سيدة الأناقة', category: 'avatar', image_url: '/avatars/girl-4.png', preview_css: 'avatar-girl', points_cost: 800, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000005', name_ar: 'المبدعة الصغيرة', category: 'avatar', image_url: '/avatars/girl-5.png', preview_css: 'avatar-girl', points_cost: 200, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000006', name_ar: 'فراشة الربيع', category: 'avatar', image_url: '/avatars/girl-6.png', preview_css: 'avatar-girl', points_cost: 400, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000007', name_ar: 'أميرة القصر', category: 'avatar', image_url: '/avatars/girl-7.png', preview_css: 'avatar-girl', points_cost: 2500, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000008', name_ar: 'الفارسة الشجاعة', category: 'avatar', image_url: '/avatars/girl-8.png', preview_css: 'avatar-girl', points_cost: 600, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000009', name_ar: 'نجمة السينما', category: 'avatar', image_url: '/avatars/girl-9.png', preview_css: 'avatar-girl', points_cost: 3000, is_active: true },
  { id: 'e0e0e0e0-2222-4000-8000-000000000010', name_ar: 'الجوهرة المصونة', category: 'avatar', image_url: '/avatars/girl-10.png', preview_css: 'avatar-girl', points_cost: 4500, is_active: true },
];
